...
public class MemoSaveTh4 : MonoBehaviour
{
    ...
    public void SaveMemo()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveMemoTh4_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    void Start()
    {
        StreamReader srM1 = new StreamReader("saveMemoTh4_1.txt", Encoding.GetEncoding("UTF-8"));
