...
public class MemoSaveTh1 : MonoBehaviour
{
    ...
    public void SaveMemo()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveMemoTh1_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    void Start()
    {
        StreamReader srM1 = new StreamReader("saveMemoTh1_1.txt", Encoding.GetEncoding("UTF-8"));
