...
public class MemoSaveF5 : MonoBehaviour
{
    ...
    public void SaveMemo()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveMemoF5_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    void Start()
    {
        StreamReader srM1 = new StreamReader("saveMemoF5_1.txt", Encoding.GetEncoding("UTF-8"));
