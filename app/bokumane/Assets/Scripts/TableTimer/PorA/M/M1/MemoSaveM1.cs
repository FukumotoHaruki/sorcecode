...
public class MemoSaveM1 : MonoBehaviour {
    ...
    public void SaveMemo()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveMemoM1_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    void Start () {
        StreamReader srM1 = new StreamReader("saveMemoM1_1.txt", Encoding.GetEncoding("UTF-8"));
