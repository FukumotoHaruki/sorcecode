...
public class MemoSaveW2 : MonoBehaviour
{
    ...
    public void SaveMemo()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveMemoW2_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    void Start()
    {
        StreamReader srM1 = new StreamReader("saveMemoW2_1.txt", Encoding.GetEncoding("UTF-8"));
