...
public class SaveScriptTu5 : MonoBehaviour
{
    ...
    public void SaveInputfield()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveDataTu5_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    {
        // ファイル読み込み
        StreamReader srM1 = new StreamReader("saveDataTu5_1.txt", Encoding.GetEncoding("UTF-8"));
