...
public class SaveScriptW2 : MonoBehaviour
{
    ...
    public void SaveInputfield()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveDataW2_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    {
        // ファイル読み込み
        StreamReader srM1 = new StreamReader("saveDataW2_1.txt", Encoding.GetEncoding("UTF-8"));
