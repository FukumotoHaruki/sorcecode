...
public class SaveScriptW3 : MonoBehaviour
{
    ...
    public void SaveInputfield()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveDataW3_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    {
        // ファイル読み込み
        StreamReader srM1 = new StreamReader("saveDataW3_1.txt", Encoding.GetEncoding("UTF-8"));
