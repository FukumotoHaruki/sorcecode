...
public class SaveScriptM5 : MonoBehaviour
{
    ...
    public void SaveInputfield()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveDataM5_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    {
        // ファイル読み込み
        StreamReader srM1 = new StreamReader("saveDataM5_1.txt", Encoding.GetEncoding("UTF-8"));
