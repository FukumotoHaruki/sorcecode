...
public class SaveScriptTh1 : MonoBehaviour
{
    ...
    public void SaveInputfield()
    {
        ...
        StreamWriter sw = new StreamWriter(@"saveDataTh1_1.txt", false, Encoding.GetEncoding("UTF-8"));
    ...
    {
        // ファイル読み込み
        StreamReader srM1 = new StreamReader("saveDataTh1_1.txt", Encoding.GetEncoding("UTF-8"));
